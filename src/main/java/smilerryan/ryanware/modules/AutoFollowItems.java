...
public class AutoFollowItems extends Module {
    ...
    public AutoFollowItems() {
        super(RyanWare.CATEGORY_EXTRAS, RyanWare.modulePrefix_extras + "Auto-Follow-Items", "Automatically walks/jumps towards items with a whitelist/blacklist/max-range.");
    }
