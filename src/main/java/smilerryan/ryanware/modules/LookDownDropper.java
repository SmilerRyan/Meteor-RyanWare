...
public class LookDownDropper extends Module {
    ...
    public LookDownDropper() {
        super(RyanWare.CATEGORY_EXTRAS, RyanWare.modulePrefix_extras + "Look-Down-Dropper", "Slowly looks down, drops held item (optional), looks back up, and then optionally repeats.");
    }
