...
public class CommandAura extends Module {
    ...
    public CommandAura() {
        super(RyanWare.CATEGORY_EXTRAS, RyanWare.modulePrefix_extras + "Command-Aura", "Sends commands when players enter or leave chunks.");
    }
    ...
    private void sendCommand(PlayerEntity target, String command) {
        ...
        smilerryan.ryanware.utils.SendChat.command(commandText.substring(1)); // Remove the leading slash
    }
